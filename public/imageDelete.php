...
function ciniki_merchandise_imageDelete(&$ciniki) {
    ...
    $rc = ciniki_merchandise_checkAccess($ciniki, $args['tnid'], 'ciniki.merchandise.imageDelete');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    // Remove the image
    //
    $rc = ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.merchandise.image',
