...
function ciniki_merchandise_objects($ciniki) {
    ...
    $objects['product'] = array(
        ...
        'fields'=>array(
            ...
            'inventory_current_num'=>array('name'=>'Current Inventory', 'default'=>'0'),
            'shipping_weight'=>array('name'=>'Shipping Weight', 'default'=>'0'),
            'shipping_weight_units'=>array('name'=>'Shipping Units', 'default'=>'10'),
